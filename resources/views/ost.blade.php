...
<body style="background-color: #E5D9B6">
    ...
    <section class="berita">
        <h1>Lagu/OST</h1>
        <p>Daftar lagu/ost dari anime yang lagi populer ataupun lagu/ost pilihan mimin.</p>

        <div class="row">
            <div class="berita-col">
                <h3>Opening Populer</h3>
                <p>Yoasobi - Idol</p>
                <img src="idol.jpg" width="330px">
            </div>
            <div class="berita-col">
                <h3>Opening Terbaik (menurut mimin)</h3>
                <p>Flow - Colors</p>
                <img src="cg.jpg" width="330px">
            </div>
            <div class="berita-col">
                <h3>OST Populer</h3>
                <p>JoJo Bizarre Adventure - Golden Wind</p>
                <img src="gw.jpg" width="330px">
            </div>
        </div>
    </section>
