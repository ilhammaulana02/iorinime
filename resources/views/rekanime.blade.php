...
<head>
    ...
    <title>IORINIME | Rekomendasi Anime</title>
...
<body style="background-color: #E5D9B6">
    ...
    <section class="berita">
        ...
        <p>Rekomendasi anime pilihan dari mimin nih, semoga selera mimin juga selera kalian semua ya LOL</p>

        <div class="row">
            <div class="berita-col">
                <h3>Anime Paling Kocak menurut mimin</h3>
                <p>Grand Blue</p>
                <img src="komedi.jpeg" width="300px">
            </div>
            <div class="berita-col">
                <h3>Anime Tersedih menurut mimin</h3>
                <p>One Piece</p>
                <img src="op.jpg" width="330px">
            </div>
            <div class="berita-col">
                <h3>Anime Slice of Life terbaik menurut mimin</h3>
                <p>Wotaku ni Koi Wa Muzukashii : Love is Hard for Otaku</p>
                <img src="wotakoi.jpg" width="330px">
            </div>
        </div>
    </section>
